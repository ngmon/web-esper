...
public class MessagesReadyDetails {
    ...
    public MessagesReadyDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public MessagesReadyDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MessagesReadyDetails) == false) {
            return false;
        }
        MessagesReadyDetails rhs = ((MessagesReadyDetails) other);
