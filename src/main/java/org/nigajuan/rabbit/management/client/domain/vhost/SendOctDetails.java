...
public class SendOctDetails {
    ...
    public SendOctDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public SendOctDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SendOctDetails) == false) {
            return false;
        }
        SendOctDetails rhs = ((SendOctDetails) other);
