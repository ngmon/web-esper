...
public class RecvOctDetails {
    ...
    public RecvOctDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public RecvOctDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecvOctDetails) == false) {
            return false;
        }
        RecvOctDetails rhs = ((RecvOctDetails) other);
