...
public class DeliverGetDetails {
    ...
    public DeliverGetDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public DeliverGetDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeliverGetDetails) == false) {
            return false;
        }
        DeliverGetDetails rhs = ((DeliverGetDetails) other);
