...
public class PublishOutDetails {
    ...
    public PublishOutDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public PublishOutDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PublishOutDetails) == false) {
            return false;
        }
        PublishOutDetails rhs = ((PublishOutDetails) other);
