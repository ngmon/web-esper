...
public class PublishDetails {
    ...
    public PublishDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public PublishDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PublishDetails) == false) {
            return false;
        }
        PublishDetails rhs = ((PublishDetails) other);
