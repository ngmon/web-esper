...
public class MessagesUnacknowledgedDetails {
    ...
    public MessagesUnacknowledgedDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public MessagesUnacknowledgedDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MessagesUnacknowledgedDetails) == false) {
            return false;
        }
        MessagesUnacknowledgedDetails rhs = ((MessagesUnacknowledgedDetails) other);
