...
public class RedeliverDetails {
    ...
    public RedeliverDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public RedeliverDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RedeliverDetails) == false) {
            return false;
        }
        RedeliverDetails rhs = ((RedeliverDetails) other);
