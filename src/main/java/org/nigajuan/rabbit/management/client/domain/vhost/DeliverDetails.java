...
public class DeliverDetails {
    ...
    public DeliverDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public DeliverDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeliverDetails) == false) {
            return false;
        }
        DeliverDetails rhs = ((DeliverDetails) other);
