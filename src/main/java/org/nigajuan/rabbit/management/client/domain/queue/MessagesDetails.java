...
public class MessagesDetails {
    ...
    public MessagesDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public MessagesDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MessagesDetails) == false) {
            return false;
        }
        MessagesDetails rhs = ((MessagesDetails) other);
