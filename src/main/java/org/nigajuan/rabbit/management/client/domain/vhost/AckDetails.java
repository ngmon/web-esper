...
public class AckDetails {
    ...
    public AckDetails withRate(Double rate) {
        this.rate = rate;
        return this;
    }
    ...
    public AckDetails withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AckDetails) == false) {
            return false;
        }
        AckDetails rhs = ((AckDetails) other);
